...
<p align="justify"> &emsp;&emsp;A release 1 foi de grande importância para a equipe, pois foi possível realizar o levantamento dos pontos positivos e negativos. Percebemos que o que mais prejudicou a equipe foi a falta de habilidade dos integrantes nas práticas ágeis, principalmente na falta da utilização das métricas, propostas pelo método scrum, pois sem elas não era possível fazer uma análise precisa do rendimento do time.</p>

## Entrega da R2
<p align="justify"> &emsp;&emsp;Durante o processo da release 2, o time evoluiu muito em relação a aplicação das prática ágeis, o que nos fez entregar um trabalho mais completo e detalhado do que na release 1. Devemos confessar que houveram momentos em que pensamos que não iriamos conseguir entragar nada, mas isso acontece com todos os grupos em todos os semestres, mas no fim acaba dando certo. O nível de estresse é absurdo, principalmente se estiver lidando com muitas matérias, mas MDS nos ensinou o verdadeiro significado de trabalhar em equipe em prol de um objetivo em comum. Apesar de todo desepero, é muito gratificante ver o resultado final e saber que conseguimos aquilo juntos.</p>
